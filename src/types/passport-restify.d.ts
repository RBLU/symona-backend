...
declare namespace passport {
    ...
    interface Passport {
        ...
        authenticate(strategy: string|string[], callback?: (...args: any[]) => any): restify.RequestHandler;
        authenticate(strategy: string|string[], options: AuthenticateOptions, callback?: (...args: any[]) => any): restify.RequestHandler;
        authorize(strategy: string|string[], callback?: (...args: any[]) => any): restify.RequestHandler;
        authorize(strategy: string|string[], options: any, callback?: (...args: any[]) => any): restify.RequestHandler;
    ...
    interface Strategy {
        name?: string;
        authenticate(req: restify.Request, options?: any): void;
    }
